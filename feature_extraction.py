...
"""
The following code is based on Pyradiomics library implementations. 
For more details, please refer to the documentation at "https://github.com/AIM-Harvard/pyradiomics".

"""

def main():

  inputCSV = "./image_path.csv"
  outputFilepath = "./extracted_feature.csv"
  progress_filename = "./pyrad_log.txt"
  params = "./Params3.yaml"
  ...
  for entry in flists:  # Loop over all columns (i.e. the test cases)
    ...
    if (imageFilepath is not None) and (maskFilepath is not None):
      ...
      try:
        ...
        featureVector = pandas.concat([featureVector, result], axis=0)
      except Exception:
